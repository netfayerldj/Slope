...
namespace ClassLibrary
{
    ...
    public class Class
    {
        ...
        static public void spx2()
        {
            ...
            if (isDrillSlope)
                myDSS.DrawShortLine2(drillPt, bottomCurve, step2, myColor, top2);
            else
                myDSS.DrawShortLine1(topCurve, bottomCurve, step1, myColor, top1);
    ...
    public class DrawSlope
    {
        ...
        public void DrawShortLine1(Curve topCurve, Curve bottomCurve, double step, int colorIndex, bool top)
        {
        ...
        public void DrawShortLine2(Point3d pt, Curve myCurve, double step, int colorIndex, bool top)
        {
            DotNetArxLH.LhDraw.LhLine lhline = new DotNetArxLH.LhDraw.LhLine();
